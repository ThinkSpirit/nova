...
#from nova.virt.openvz.network import OVZNetworkFile, OVZNetworkInterfaces
...
class OpenVzDriverTestCase(test.TestCase):
    ...
    def test_start_success(self):
        ...
        openvz_conn.db.instance_update(
    ...
    def test_list_instances_success(self):
        ...
        openvz_conn.utils.execute(
            ...
            run_as_root=True).AndReturn((fakes.VZLIST, fakes.ERRORMSG))
        # Start test
        self.mox.ReplayAll()
        conn = openvz_conn.OpenVzDriver(False)
    ...
    def test_set_vz_os_hint_success(self):
        ...
        openvz_conn.utils.execute(
            ...
            'ubuntu', run_as_root=True).AndReturn(('', fakes.ERRORMSG))
        self.mox.ReplayAll()
        conn = openvz_conn.OpenVzDriver(False)
    ...
    def test_configure_vz_success(self):
        ...
        openvz_conn.utils.execute(
            ...
            'basic', run_as_root=True).AndReturn(('', fakes.ERRORMSG))
        self.mox.ReplayAll()
        conn = openvz_conn.OpenVzDriver(False)
    ...
    def test_stop_failure_on_db_access(self):
        ...
        conn = openvz_conn.OpenVzDriver(False)
        self.assertRaises(
            exception.DBError, conn._stop, fakes.INSTANCE)
    ...
    def test_access_control_invalid_access_type(self):
        ovz_conn = openvz_conn.OpenVzDriver(False)
        self.assertRaises(exception.InvalidInput, ovz_conn._access_control,
            fakes.INSTANCE, '1.1.1.1', port=22, access_type='invalid')

    def test_resize_in_place_success(self):
        ovz_conn = openvz_conn.OpenVzDriver(False)
        self.mox.StubOutWithMock(ovz_conn, '_set_instance_size')
        ovz_conn._set_instance_size(fakes.INSTANCE, fakes.INSTANCETYPE['id'])
        self.mox.StubOutWithMock(ovz_conn, 'reboot')
        ovz_conn.reboot(fakes.INSTANCE, None, None)
        self.mox.ReplayAll()
        self.assertTrue(
            ovz_conn.resize_in_place(
                fakes.INSTANCE, fakes.INSTANCETYPE['id'], True))

    def test_resize_in_place_failure(self):
        ovz_conn = openvz_conn.OpenVzDriver(False)
        self.mox.StubOutWithMock(ovz_conn, '_set_instance_size')
        ovz_conn._set_instance_size(fakes.INSTANCE).AndRaise(Exception)
        self.mox.ReplayAll()
        self.assertRaises(
            exception.InstanceUnacceptable,
            ovz_conn.resize_in_place, fakes.INSTANCE,
            fakes.INSTANCETYPE['id'] ,True)
    ...
    def test_set_instance_size_with_instance_type_id(self):
        ...
        openvz_conn.instance_types.get_instance_type(
            fakes.INSTANCETYPE['id']).AndReturn(fakes.INSTANCETYPE)
        ovz_conn = openvz_conn.OpenVzDriver(False)
        ...
        ovz_conn._set_diskspace(fakes.INSTANCE, fakes.INSTANCETYPE)
        ...
        ovz_conn._set_instance_size(
            fakes.INSTANCE, fakes.INSTANCETYPE['id'], fakes.NETWORKINFO)
    ...
    def test_set_instance_size_without_instance_type_id(self):
        ...
        self.mox.ReplayAll()
        ovz_conn._set_instance_size(
            fakes.INSTANCE, None, fakes.NETWORKINFO)
    ...
    def test_generate_tc_rules(self):
        ...
        openvz_conn.OVZTcRules().MultipleTimes().AndReturn(
    ...
    def test_set_ioprio_too_high_success(self):
        ...
        openvz_conn.utils.execute(
            'vzctl', 'set', fakes.INSTANCE['id'], '--save', '--ioprio',
            7, run_as_root=True).AndReturn(('', fakes.ERRORMSG))
        conn = openvz_conn.OpenVzDriver(False)
        self.mox.ReplayAll()
        conn._set_ioprio(
    ...
    def test_attach_volume(self):
        self.mox.StubOutWithMock(openvz_conn, 'OVZISCSIStorageDriver')
        openvz_conn.OVZISCSIStorageDriver(
            fakes.BDM['block_device_mapping'][0]['connection_info'],
            fakes.FINDBYNAME['id'], mox.IgnoreArg()).AndReturn(
                fakes.FakeOVZISCSIStorageDriver())
        ovz_conn = openvz_conn.OpenVzDriver(False)
        self.mox.StubOutWithMock(ovz_conn, '_find_by_name')
        ovz_conn._find_by_name(
            fakes.INSTANCE['name']).AndReturn(fakes.FINDBYNAME)
        self.mox.ReplayAll()
    ...
    def test_init_host_no_state(self):
        self.mox.StubOutWithMock(openvz_conn, 'OVZBootFile')
        openvz_conn.OVZBootFile(
            mox.IgnoreArg(), mox.IgnoreArg()).AndReturn(
            fakes.FakeOVZBootFile(0, 700))
        ...
        self.mox.StubOutWithMock(openvz_conn.db, 'instance_get_all_by_host')
        openvz_conn.db.instance_get_all_by_host(
            mox.IgnoreArg(), socket.gethostname()).AndReturn([fakes.INSTANCE])
        self.mox.StubOutWithMock(openvz_conn.db, 'instance_destroy')
        openvz_conn.db.instance_destroy(
            fakes.ADMINCONTEXT, fakes.INSTANCE['uuid']).AndRaise(
                exception.DBError)
        self.mox.StubOutWithMock(openvz_conn.context, 'get_admin_context')
        openvz_conn.context.get_admin_context().AndReturn(fakes.ADMINCONTEXT)
        self.mox.StubOutWithMock(openvz_conn, 'OVZInstanceVolumeOps')
        openvz_conn.OVZInstanceVolumeOps(fakes.INSTANCE).AndReturn(
            fakes.FakeOVZInstanceVolumeOps(fakes.INSTANCE))
        ovz_conn = openvz_conn.OpenVzDriver(False)
        self.mox.StubOutWithMock(ovz_conn, 'get_info')
        ovz_conn.get_info(fakes.INSTANCE).MultipleTimes().AndRaise(
    ...
    def test_init_host_not_found(self):
        self.mox.StubOutWithMock(openvz_conn.db, 'instance_get_all_by_host')
        openvz_conn.db.instance_get_all_by_host(
            mox.IgnoreArg(), socket.gethostname()).AndReturn(fakes.INSTANCES)
        ovz_conn = openvz_conn.OpenVzDriver(False)
        self.mox.StubOutWithMock(ovz_conn, 'get_info')
    ...
    def test_reboot_success(self):
        self.mox.StubOutWithMock(openvz_conn.context, 'get_admin_context')
        openvz_conn.context.get_admin_context().MultipleTimes().AndReturn(
            fakes.ADMINCONTEXT)
        self.mox.StubOutWithMock(openvz_conn, 'OVZShutdownFile')
        openvz_conn.OVZShutdownFile(
            fakes.INSTANCE['id'], mox.IgnoreArg()).AndReturn(
    ...
    def test_reboot_failure(self):
        ...
        ovz_conn = openvz_conn.OpenVzDriver(False)
        self.assertRaises(
            exception.InstanceUnacceptable, ovz_conn.reboot, fakes.INSTANCE,
            fakes.NETWORKINFO, 'hard')
    ...
    def test_inject_files(self):
        ...
        ovz_conn.inject_file(
            ...
            b64encode(fakes.FILECONTENTS)).MultipleTimes()
        self.mox.ReplayAll()
    ...
    def test_inject_file(self):
        ...
        self.mox.StubOutWithMock(openvz_conn, 'OVZFile')
        openvz_conn.OVZFile(
            full_path, 644).AndReturn(fakes.FakeOvzFile(full_path, 644))
        self.mox.ReplayAll()
        ovz_conn = openvz_conn.OpenVzDriver(False)
        ovz_conn.inject_file(
            fakes.INSTANCE, b64encode(fakes.FILESTOINJECT[0][0]),
            b64encode(fakes.FILESTOINJECT[0][1]))
    ...
    def test_clean_orphaned_files(self):
        ...
        self.mox.StubOutWithMock(openvz_conn.ovz_utils, 'execute')
        openvz_conn.ovz_utils.execute(
            'rm', '-f', mox.IgnoreArg(), run_as_root=True,
            raise_on_error=False).MultipleTimes()
        self.mox.ReplayAll()
        ovz_conn = openvz_conn.OpenVzDriver(False)
        ovz_conn._clean_orphaned_files(fakes.INSTANCE['id'])

    def test_clean_orphaned_directories_success(self):
        self.mox.StubOutWithMock(openvz_conn.ovz_utils, 'execute')
        openvz_conn.ovz_utils.execute(
            'rm', '-rf', mox.IgnoreArg(), run_as_root=True,
            raise_on_error=False)
        self.mox.ReplayAll()
        ovz_conn = openvz_conn.OpenVzDriver(False)
        ovz_conn._clean_orphaned_directories(fakes.INSTANCE['id'])

    def test_clean_orphaned_directories_bad_instance_id(self):
        ovz_conn = openvz_conn.OpenVzDriver(False)
        self.assertRaises(
            exception.InvalidDevicePath, ovz_conn._clean_orphaned_directories,
            'bad id')

    def test_clean_orphaned_directories_id_not_int(self):
        ovz_conn = openvz_conn.OpenVzDriver(False)
        self.assertRaises(
            exception.InvalidDevicePath, ovz_conn._clean_orphaned_directories,
            [fakes.INSTANCE['id']])
    ...
    def test_destroy_fail_on_exec(self):
        ...
        self.mox.StubOutWithMock(openvz_conn.utils, 'execute')
        openvz_conn.utils.execute(
            'vzctl', 'destroy', fakes.INSTANCE['id'],
            run_as_root=True).AndRaise(exception.InstanceUnacceptable)
        self.mox.ReplayAll()
        self.assertRaises(
    ...
    def test_destroy_success(self):
        ...
        ovz_conn._clean_orphaned_files(fakes.INSTANCE['id'])
        self.mox.StubOutWithMock(
            openvz_volume_ops.OVZInstanceVolumeOps, 'detach_all_volumes')
        openvz_volume_ops.OVZInstanceVolumeOps(
            fakes.INSTANCE).detach_all_volumes()
        self.mox.ReplayAll()
    ...
    def test_spawn_failure(self):
        ...
        self.mox.ReplayAll()
        timer = ovz_conn.spawn(
            fakes.ADMINCONTEXT, fakes.INSTANCE, None, None,
            fakes.ROOTPASS, fakes.NETWORKINFO, fakes.BDM)
        timer.wait()
    ...
    def test_add_to_aggregate(self):
        self.mox.StubOutWithMock(openvz_conn.db, 'aggregate_update')
        openvz_conn.db.aggregate_update(
            fakes.ADMINCONTEXT, fakes.AGGREGATE.id, mox.IgnoreArg())
        self.mox.ReplayAll()
        ovz_conn = openvz_conn.OpenVzDriver(False)
        ovz_conn.add_to_aggregate(
            fakes.ADMINCONTEXT, fakes.AGGREGATE, CONF.host)
